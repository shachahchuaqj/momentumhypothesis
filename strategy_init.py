...
if __name__ == "__main__":
    ...
    for_return, for_tradedata = force(initial_amount, Xshares=10)
    forTP_return, forTP_tradedata = force(initial_amount, Xshares=10, use_take_profit=True, take_profit_pct=10, account_name='Force with Take Profit')
    forTPNSL_return, forTPNSL_tradedata = force(initial_amount, Xshares=10, use_take_profit=True, take_profit_pct=10, use_stop_loss=False, 
